//! This demonstrates how to parse recursive lists using `errgonomic`.
//! It also shows how to use the parser combinators to add additional positional information to
//! your structured output, via `Input`.
